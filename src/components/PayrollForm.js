...
export default function PayrollForm(props) {
  ...
  const onCheckChange = (name) => {
    let index = userData.departments.indexOf(name);

    let checkArray = [...userData.departments];

    if (index > -1) checkArray.splice(index, 1);
    else checkArray.push(name);

    setUserData({ ...userData, departments: checkArray });
  ...
  const getChecked = (name) => {
    return (
      ...
      userData.departments.includes(name)
    );
  };
            ...
            <div className="profile-radio-content">
              <label>
                <input
                  ...
                  required
                  // checked={userData.profile === "../assets/profile-images/Eclipse-1.PNG"}
                  onChange={(event) => {
                    handleInput(event);
                  }}
                />
          ...
          <div className="buttonParent">
            ...
            <div className="submit-reset">
              <button
                ...
                id="submitButton"
              >
                {userData.isUpdate ? "Update" : "Submit"}
              </button>
              <button
                type="reset"
